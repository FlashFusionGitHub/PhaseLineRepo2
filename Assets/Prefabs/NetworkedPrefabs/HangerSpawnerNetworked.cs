...
public class HangerSpawnerNetworked : MonoBehaviour {
    ...
    [Header("Door Stuff")]
    [SerializeField]
    private HangerDoorData[] m_hangerDoors;
    ...
    [Header("Object Pool")]
    [SerializeField] private ObjectPoolNetworked objectPool;

    // Use this for initialization
    void Start () {
        objectPool = FindObjectOfType<ObjectPoolNetworked>();
    }
    ...
    TroopActorNetworked ObjectToSpawnAvaliable()
    {
        foreach (TroopActorNetworked ta in objectPool.allTroopActors)
        {
